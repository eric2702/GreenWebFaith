...
<body>
    <!-- <div class="special-autocom">
        ...
        <div class="autocom-box2 bg-white d-lg-block d-none text-center">
    ...
    <div class="special-autocom">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <div class="search-input">
                        ...
                        <div class="row" style="background: #f8f9fa!important">
                            <div class="col-lg-10 col-11 p-0">
                                <input id="searchID" type="text" placeholder="Search..">
                        ...
                        <div class="autocom-box d-block d-lg-none" style="background: #f8f9fa!important;">
        ...
        <div class="autocom-box2 bg-white d-lg-block d-none text-center" style="background: #f8f9fa!important;">
    ...
    <div class="container-fluid h-100">
        ...
        <div class="row justify-content-center h-100">
            ...
            <div style="min-height: 500px;" class="h-75 col-sm-12 col-12 col-md-8 col-xl-6 chat">
                <div id="chat-all-box" class="card h-100">
                    <div class="card-header msg_head">
                        <div class="d-flex bd-highlight">
                            <div id="border-img" class=" img_cont">
                                <img src="" id="profile-img" class="rounded-circle user_img">
                                <!-- <span class="online_icon"></span> -->
                            </div>
                            <div class="user_info">
                                <span id="chat-top-name"></span>
                                <p id="chat-top-username"></p>
                            </div>
                            <!-- <div class="video_cam">
                    ...
                    <div id="chat-box" class="card-body msg_card_body">
                        <div class="output">
                    ...
                    <div id="text-send-area" class="card-footer">
                        <div class="input-group">
                            ...
                            <div id="send-button" class="input-group-append">
    ...
    function unfocusChat() {
        $('#chat-top-name').html("");
        $('#chat-top-username').html("");

        $('#chat-box').html("");
        $('#text-send-area').hide();
        $('#border-img').hide();
        $('#action_menu_btn').hide();
        //remove send button

    }

    function getChat(id_room) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#chat-top-username').html(other_user_username);

                $('#chat-box').html(chat_html);
                //set room id in send button
    ...
    function sendMessage(id_room) {
        var message = $('#chat-all-box textarea').val().trim();
        if (message != '') {
            $.ajax({
