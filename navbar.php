  ...
  <div class="modal fade" id="logInModal" tabindex="-1" aria-labelledby="logInModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      ...
      <div class="modal-body" style="">
       ...
       <button type="button" style="float:right;" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
       <h2>Login</h2>
        ...
        <div class="row">
          <p id="turnSignUp" style="color: white; text-decoration: underline; cursor: pointer;">Dont have an account?</p>
        </div>
        <div class="row">
          <div class="col-4"></div>
          <div class="col-4">
    ...
    <div class="modal-body" style="">
      ...
      <div class="container login-box">
       ...
       <h2>Create Account</h2>
        ...
        <button style=" float:  right ;" id="req">Request</button>
        <div class="row">
          <p id="turnLogin" style="color: white; text-decoration: underline; cursor: pointer;">Have an account?</p>
        </div>
        <div class="row">
          <div class="col-4"></div>
          <div class="col-4">
