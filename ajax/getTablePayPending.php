...
<button id="accept-'.$result['id'].'" type="button"" class="btn btn-warning accdong"><i class="fa-solid fa-check"></i></button><button id="reject-'.$result['id'].'" type="button" class="btn btn-danger reject"><i class="fa-solid fa-xmark"></i></button></td>
                        </tr> 
